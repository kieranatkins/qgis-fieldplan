...
INFO="""
Takes field plan generated by the \"Field plan - Create new\" function, and after adequate deletions have been made,
a new ID system is created that follows the rows along the original bearing, imitating the way a tractor may move
in the field, with functionality for row and/or board serpentine IDs.
----------\n
Parameters:\n
----------\n
Input field plan - Field plan created by the \"Field plan - Create new\" function, to have IDs resolved.
            ...
            for block in blocks.values():
                ...
                for board in boards.values():
                    ...
                    for i, plot in enumerate(board):
                        ...
                        plot_map.update({int(plot['id']):int(i)})
                        resolved_id += 1
